        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <tr>
                    ...
                    <td>{{ $fd->nm_menu}}</td>
                    <td>
                        <a href="{{ asset ('img/'. $fd->gambar ) }}" target="blank">Lihat Gambar</a>
                    </td>
                    <td>{{ number_format($fd->harga)}}</td>
                    <td align="center"><a href="{{ route('food.edit',[$fd->kd_menu])}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                        <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a>
                            <a href="/food/hapus/{{$fd->kd_menu}}" onclick="return confirm('Yakin Ingin Menghapus Data?')" class="d-nine d-sm-inline-block btn btn-sm btn-danger shadow-sm">
